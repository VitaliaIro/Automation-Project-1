...
describe('This is first test suite, Vitalia Iro', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        // 15.11.2023
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Vitalia')
        cy.get('[data-testid="lastNameTestId"]').type('Iro')
        cy.get('input[name="password"]').type('pAr0lSh0UlDInCluDe123')
        cy.get('[name="confirm"]').type('pAr0lSh0UlDInCluDe123')
    ...
    */
    ...
    it('User cannot submit data when password and/or confirmation password is absent', () => {
        ...
        // Scroll back to password input fields
